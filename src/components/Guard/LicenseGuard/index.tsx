...
export const LicenseGuard: React.FC<LicenseGuardProps> = ({ children }) => {
    ...
    if (license.isExpired) {
        return <ThemeWrapper><ExpiredScreen machineId={license.machineId} showManual={showManual} isValidating={license.isValidating} onSync={license.verifyWithHub} onReset={async () => { await invoke('save_license_key', { key: '' }); window.location.reload(); }} /></ThemeWrapper>;
    }
